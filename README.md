...
### Requirements
1 You need to install [**Docker**](https://github.com/ArijMekki/Open-Source-SAST/blob/main/Docker.md) and **Docker compose** in order to run the **Semgrep** and **ELK** images.
### Installation
### Usage
